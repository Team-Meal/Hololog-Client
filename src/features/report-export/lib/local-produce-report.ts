...
import type { LocalProduceStats } from "@/entities/ingredient";
import { escapeHtml, openPrintWindow } from "./html";

export type { LocalProduceStats, CategoryCount } from "@/entities/ingredient";
export { computeLocalProduceStats } from "@/entities/ingredient";
