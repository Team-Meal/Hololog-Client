...
export function SchoolForm({
  ...
  return (
    <div className="flex flex-col gap-8">
      <SectionTitle title="학교 정보 수정" description="소속 학교를 검색해 변경하세요." />
      ...
      <div className="flex justify-end gap-2">
        <button
          ...
          disabled={saving}
          onClick={onCancel}
          className="inline-flex h-10 items-center justify-center rounded-xl px-4 text-sm font-semibold text-zinc-500 transition-colors hover:bg-zinc-100 disabled:pointer-events-none disabled:opacity-40"
        >
          취소
        </button>
        <button
